...
function Header({ forMobile, Mobile }: HeaderProps) {
  return (
    <div>
      <div className="hidden md:flex justify-between px-[16px] py-2 text-sm border-b">
        <div>Phone Number: +92 000 00000</div>
      ...
      <nav className="border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Button className="md:hidden" variant="ghost" onClick={() => Mobile((prev) => !prev)}>
