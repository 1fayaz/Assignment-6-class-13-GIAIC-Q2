          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {testimonials.map((testimonial) => (
              <Card 
                ...
                className="border-[1px] border-black min-h-[250px] flex flex-col"
              >
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-2">
              <Button
                ...
                aria-label="Previous slide"> <MdChevronLeft className="h-5 w-5" />
              </Button>
              <Button
                variant="outline"
                size="icon"
                className="h-10 w-10 rounded-full border-gray-200"
                aria-label="Next slide"> <MdChevronRight className="h-5 w-5" />
              </Button>
            </div>
          </div>
        </div>
